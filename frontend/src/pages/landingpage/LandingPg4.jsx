...
function LandingPg4() {
  ...
  return (
    <div id="how-it-works" className='w-full h-full px-4 md:px-10 lg:px-14 bg-[#21B557] flex flex-col justify-around items-center'>
        ...
        <div className='flex justify- items-center text-[#093218] font-bold text-5xl w-full'>
          <div className='w-7/12 p-4'>
            <div key={currentItem.title} className="w-4/5 leading-[3rem] transition-opacity duration-300">
              {currentItem.content}
            </div>
          </div>
