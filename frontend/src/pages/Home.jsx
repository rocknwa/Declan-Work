      ...
      <section className='text-center flex items-center flex-col'>
        ...
        <div className='mt-10 flex flex-col items-center'>
            ...
            <div className='flex flex-col items-center w-50ch md:60ch lg:w-[85ch] gap-4 px-5'>
                <h1 className='text-[#000] text-[40px] tracking-tighter leading-[1.1] lg:tracking-[-2px] lg:text-[64px] lg:leading-[70px] font-semibold'>It use to start with a dream, now you can start here</h1>
