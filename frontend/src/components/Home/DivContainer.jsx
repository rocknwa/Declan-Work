...
const divs = [
    { text: "UI/UX DESIGNER", style: { top: '9.9331vh', left: '34.0703vw' }, className: "bg-red-200" },
    { text: "SOCIAL MEDIA MANAGER", style: { top: '10.2331vh', left: '54.0703vw' }, className: "bg-blue-200" },
    { text: "FRONTEND DEVELOPER", style: { top: '60.7217vh', left: '75.5902vw' }, className: "bg-green-200" },
    { text: "BACKEND DEVELOPER", style: { top: '32.9598vh', left: '82.2797vw' }, className: "bg-yellow-200" },
    { text: "FULLSTACK DEVELOPER", style: { top: '21.5662vh', left: '82.82384vw' }, className: "bg-purple-200" },
