...
function HowItWorksNav({selectedItemTitle, setSelectedItemTitle}) {
  ...
  return (
    <nav className='flex w-full lg:w-auto lg:flex-wrap lg:justify-center items-center overflow-x-hidden gap-x-1 lg:gap-x-2 rounded-full bg-white lg:py-2 px-1'>
