          ...
          <CardContent>
            ...
            <div className="overflow-hidden rounded-md border">
              <Table className="text-center">
                <TableHeader>
                  <TableRow>
                    <TableHead className=" flex items-center ml-8 ">Client Name</TableHead>
                ...
                <TableBody>
                  {
                    fakeData.transactions.map(
                      ({clientName, project, price, deliveredIn, id}) => (
                        <DashboardTableRow clientName={clientName} project={project} price={price} deliveredIn={deliveredIn} key={id} />
                      )
                    )
                  }
                </TableBody>
